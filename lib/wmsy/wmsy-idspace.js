...
IdSpaceDocRegistry.prototype = {
   ...
   */
  registerBinding: function(spaceName, binding) {
   ...
   */
  unregisterBinding: function(spaceName, binding) {
    var id = this.spaceDefs[spaceName].extractor(binding.obj);
    var space = this.spaces[spaceName];
   ...
   * ]
   */
  startWatching: function(who, spaceName) {
    this.watching = true;
