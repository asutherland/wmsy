...
AnticsDocDomainInstance.prototype = {
  ...
  _animateClone: function(clonePair) {
    ...
    function transitionEnd() {
      flyer.removeEventListener("webkitTransitionEnd", transitionEnd, true);
      flyer.removeEventListener("transitionend", transitionEnd, true);
      flyer.parentNode.removeChild(flyer);
      // stop forcing crap on the target
      target.style.cssText = "";
    }
    flyer.addEventListener("webkitTransitionEnd", transitionEnd, true);
    flyer.addEventListener("transitionend", transitionEnd, true);
  ...
  _animateRemoval: function(binding) {
    ...
    function transitionEnd() {
      container.removeEventListener("webkitTransitionEnd", transitionEnd, true);
      container.removeEventListener("transitionend", transitionEnd, true);
      container.parentNode.removeChild(container);
    }
    container.addEventListener("webkitTransitionEnd", transitionEnd, true);
    container.addEventListener("transitionend", transitionEnd, true);
