...
require.def("wmsy/examples/music-wowser",
  [
    "wmsy/wmsy",
    "exports",
  ],
...
var wy = new $wmsy.WmsyDomain({id: "music-wowser", clickToFocus: true});

wy.defineIdSpace("album", function(album) {
                   return album.id;
                 });

wy.defineStyleBase("albums", [
  "@album-line-height: 170px;",
  "@album-big: 150px;",
  "@album-small: 50px;",
]);
...
wy.defineWidget({
  ...
  receive: {
    enqueue: function(album) {
      ...
      this.obj.queue.unshift(album);
      this.queued_slice.splice(0, 0, [album]);
