...
console.log("E ensureVisible", this.obj.id);
...
console.log("E runup found", bindyNode);
...
WidgetProtoFab.prototype = {
  ...
  addWidgetList: function(aNodeName, aConstraintBasis, aSeparator,
    ...
    this.proto[aNodeName + "_ensureVisible"] = function $_ensureVisible(
      ...
      var kicontainerNode = aBinding.domNode;
      var kidLen = kicontainerNode[clientLenAttr];
