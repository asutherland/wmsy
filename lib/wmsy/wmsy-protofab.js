...
WidgetProtoFab.prototype = {
  ...
  addWidgetList: function(aNodeName, aConstraintBasis, aSeparator,
                          aElemOverride, aVertical, aDomain, aDecorated) {
    ...
    this.proto[aNodeName + "_set"] = function $_set(aVal, aForce) {
      ...
      // XXX v8 currently lacks isArray.
      if ("length" in aVal) {
      ...
      if (aDecorated) {
        aVal = new aDecorated.constructor(
          aVal, this[sliceListenerAttrName], aDecorated.sliceDef, this);
      }
      // request everything
