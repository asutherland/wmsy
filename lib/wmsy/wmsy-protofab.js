...
var WidgetProto_WidgetList_DOC = {
   ...
   */
  $_splice: function(aMakeThisHappen, aIndex, aHowManyToDelete, aValues) {
  },
...
WidgetProtoFab.prototype = {
  ...
  addWidgetList: function(aNodeName, aConstraintBasis, aSeparator,
    ...
    var spliceAttrName = aNodeName + "_splice";

    this.proto[spliceAttrName] = function $_splice(aMakeThisHappen, aIndex,
                                                   aHowMany, aValues) {
      var domNode = this[elemAttrName];
      var partial = this[partialAttrName];
      var itemMap = (aIdAttr !== NONE) ? this[itemElemMapAttrName] : null;
      // -- remove bit
