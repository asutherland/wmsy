...
WmsyWrappedElement.prototype = {
  ...
  emitOntoRoot: function(aConstraintWithObj) {
    return this.domain.emitOntoRoot(aConstraintWithObj, this.domElem);
  },
};
...
console.log("  REBUILT");
  ...
  emitOntoRoot: function(aConstraintWithObj, aDomElem) {
    var widgetFab = this.dtree.evaluate(aConstraintWithObj);
    return widgetFab.bindOnto(aConstraintWithObj, aDomElem);
  },
