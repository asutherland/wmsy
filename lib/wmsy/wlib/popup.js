...
wy.defineWidget({
  ...
  impl: {
    ...
    __sized: function(aSizing) {
      ...
      fixerNode.style.width = this.domNode.clientWidth + "px";
      ...
      // - position ourselves at our negative height for cool fly-in animation
      var win = domNode.ownerDocument.defaultView;
      domNode.style.setProperty($platfo.transitionPropAttr, "none", null);
//      console.log("deciding to put it at", win.scrollY - trueHeight,
//                  "current scrollY", win.scrollY);
//      var cs = win.getComputedStyle(domNode);
//      console.log("display", cs.display, "position",
//                  cs.position);
      domNode.style.top = (win.scrollY - trueHeight) + "px";
      domNode.clientTop;
//      var cs2 = win.getComputedStyle(domNode);
//      console.log("top thinks iti s:", domNode.style.top, "computedpre", cs.top,
//                  "post", cs2.top);
