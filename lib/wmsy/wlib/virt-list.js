...
wy.defineWidget({
  ...
  protoConstructor: function (aConstraint, aGenesisDomNode) {
    ...
    if (subConstraintBasis instanceof WmsyStructMarker) {
      ...
      this._fabBefore = function(aItem, aBeforeNode, aParentNode,
        ...
        widgetFab.insertBefore(subConstraintBasis, aBeforeNode, aParentNode,
                               aElemOverride);
      };
    }
  ...
  impl: {
    ...
    _finishSeek: function() {
      ...
      var focalBinding = this.layoutBindNucleus(
                           this.containerNode,
                           this.liveList[this.seekFocusIndex]);

      this.layoutBindAround(focalBinding, -1, this.liveList,
                            this.seekFocusIndex - 1, 0);
      this.layoutBindAround(focalBinding,  1, this.liveList,
                            this.seekFocusIndex + 1, this.liveList.length - 1);
