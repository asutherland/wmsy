...
exports.illegalFormatterSpec = function(aSpec) {
...
exports.illegalViewSliceDecoratorKind = function(aDecorMaker) {
  return new Error(aDecorMarker.kind + " is not an acceptable view " +
                   "slice decoration type.");
};

exports.illegalWmsyObjDecoratorKind = function(aObjDecorator) {
  return new Exception("Unsupported WmsyObjDecorator kind: " +
                       aObjDecorator.kind);
};
...
exports.illegalFocusValue = function(aFocusDef) {
  return new Error("Illegal 'focus' value: " + aFocusDef);
};

exports.focusDefMissingChildren = function(aFocusDef) {
  new Error("You need to list the container's focusable children " +
