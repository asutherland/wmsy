...
WmsyExportDomain.prototype = {
   ...
   *  mechanisms.
   */
  button: function(aButtonLabel) {
    return new WmsyStructMarker("button", null, aButtonLabel);
  },

  /**
   * Define an interposing view slice decorator.
   *
   * @param aDef.classifier
   * @param aDef.maker
   */
  defineInterposingViewSlice: function(aDef) {
    

    return function(aInterposedConstraint, aNormalConstraint, aBindAttr) {
      return new WmsyStructMarker("viewSliceDecorator", {
        interposedConstraint: aInterposedConstraint,
