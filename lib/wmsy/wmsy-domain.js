...
console.log("  REBUILT");
  ...
  emit: function(aConstraintWithObj, aDomElem) {
    ...
    // perform an initial focusing if the binding has a focus domain...
    if ("_focusDomain" in binding) {
      var focusManager = doc.wmsyFocusManager;
      focusManager.performInitialFocus(binding, binding._focusDomain);
    }
